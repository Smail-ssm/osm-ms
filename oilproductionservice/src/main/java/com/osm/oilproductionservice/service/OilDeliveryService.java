...
import com.osm.oilproductionservice.dto.OilDeliveryDTO;
...
@Service
public class OilDeliveryService extends BaseServiceImpl<OilDelivery, OilDeliveryDTO, OilDeliveryDTO> {

    private final GenericRepository genericRepository;
    private final DeliveryRepository deliveryRepository;

    public OilDeliveryService(BaseRepository<OilDelivery> repository, ModelMapper modelMapper, GenericRepository genericRepository, DeliveryRepository deliveryRepository) {
