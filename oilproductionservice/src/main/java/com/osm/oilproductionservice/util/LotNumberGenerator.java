...
//     */
//    public static String generateLotNumber(UnifiedDelivery delivery) {
//        // Ensure the delivery has an ID.
//        if (delivery.getId() == null) {
//            throw new IllegalArgumentException("UnifiedDelivery ID must be set before generating a lot number.");
//        }
//
